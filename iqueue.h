...
class IQueue{
     ...
     ******************************************/
     ...
     void helpSet(Node* aNode);
     Node* helpMerge(Node* aNode, Node* bNode);
     Node* helpCopy(Node* aNode);
     void helpDelete(Node* aNode);
     void helpPrint(Node* aNode) const;
     /*Node* getLeft(const Node* temp) const{ // For testing purposes
        return m_left;
     }

     Node* getRight() const{ // For testing purposes
        return m_right;
     }*/
};
#endif
